<template>
  <div>
    ...
    <p>
      Osebni podatek je katerakoli informacija, ki vas identificira kot
      določenega ali določljivega posameznika. Posameznik je določljiv takrat,
      ko ga je mogoče neposredno ali posredno določiti, zlasti z navedbo
    ...
    <ul>
      <li>
        kontaktni podatki in podatki o vaši komunikaciji z upravljavcem (ime in
        priimek, delovno, domači naslov, elektronski naslov, telefonska
        številka, podatki o starosti in spolu, podatki ali je rezervacija
        opravljana kot družina, posameznik, par ali prijatelji, kadar je
        potrebno podatki o potnih listinah (identifikacijsko številko,
        državljanstvo, datum poteka veljavnosti in državo izdaje), podatki o
        vrsti plačilnega sredstva in morebitni drugi podatki o plačilu, v
        kolikor je potrebno, datum, ura in vsebina poštne ali elektronske
        komunikacije);
      </li>
      <li>
        zgodovina povpraševanj, nakupov darilnih bonov in rezervacij ter
        informacije o morebitnih dodatnih storitvah, kot so zavarovanja,
        parkirišča in podobno;
      </li>
      <li>
        podatke o uporabnikih spletnih strani upravljavca (IP naslov, datumi,
        ure in trajanje obiskov spletnih strani, podatki o lokaciji oz. vstopni
        točki dostopa do interneta, podatki o obiskanih podstraneh, podatki o
        opravljenih nastavitvah, idr.);
      </li>
      <li>
        podatke o registriranih oz. prijavljenih uporabnikih (elektronski
        naslov, geslo in ostale podatke in nakupih);
      </li>
      <li>
        podatke o registriranih ali neregistriranih kupcih storitev (vnosi v
        nakupovalno košarico, ime in priimek, naslov prebivališča, elektronski
        naslov, telefonska številka, naslov za dostavo darilnih bonov ali
        vaučerjev, kontaktni podatki za dostavo in telefonska številka, način
        prevzema in dostave, način plačila);
      </li>
      <li>
        podatke o uporabnikovih nakupih in izdanih računih (datum in kraj
        nakupa, kupljeni storitve, cene kupljenih storitev, skupni znesek
        nakupa, način plačila, naslov za dostavo, številka in datum izdaje
        računa, oznaka osebe, ki je izdala račun, ipd.) ter podatke o reševanju
        reklamacij izdelkov;
      </li>
      <li>
        podatke o vnosih v spletne obrazce (npr. v okviru nagradnih iger,
        prijave na e-listo ali vrsta oziroma področje zanimanja za prejemanje
        oglaševalskih sporočil);
      </li>
      <li>
        podatke kandidatov za zaposlitev glede prijave na delovna mesta (osebni
        podatki kot so ime, priimek, spol, datum in kraj rojstva, naslov,
        kontaktni podatki kot so elektronski naslov in telefonska številka,
        podatki navedeni v motivacijskem pismu in življenjepisu kot so podatki o
        izobrazbi, preteklih delovnih izkušnjah, kompetencah in sposobnostih,
        izobraževanjih in tečajih idr.);
      </li>
      <li>
        druge podatke, ki jih uporabniki prostovoljno podajo upravljavcu ob
        naročilu določene storitve ali posredovanju ponudbe oziroma
        povpraševanja;
      </li>
      <li>
        sporočila, ki jih izmenjujete z nami, ali nam jih pošljete preko SMS,
        e-poštnih sporočil, klepetalnic, telefonskih klicev in socialnih
        medijev.
      </li>
    </ul>
    <p>
      Upravljavec ne zbira in ne obdeluje vaših osebnih podatkov, razen kadar mu
      vi to omogočite oz. v to privolite, tj. ob naročilu storitev in izdelkov,
      ko se naročite na prejemanje akcij in novosti preko naše e-liste,
      sodelujete v nagradni igri itd., ali kadar za zbiranje osebnih podatkov
      obstaja zakonska podlaga ali imamo za obdelavo vaših podatkov zakonite
      interese.
    </p>
    <h2>Namen obdelave podatkov in pravne podlage</h2>
    <p>
      Vsi osebni podatki, ki nam jih posredujete, bodo obravnavani zaupno in
      bodo uporabljeni zgolj v namene, za katere so bili posredovani in zbrani.
      Če bo nastala potreba po nadaljnji obdelavi vaših podatkov za drug namen,
      vas bomo predhodno kontaktirali in zaprosili za vašo predhodno pisno
      privolitev.
    </p>
    <h2>Obisk spletne strani svetina-ranch.com</h2>
    <p>
      Ob vsakem obisku naših spletnih strani se na spletnem strežniku avtomatsko
      shranjuje dnevniška datoteka spletnega strežnika. Tako zbrane (osebne)
      podatke zbiramo s pomočjo piškotkov, pri čemer vas bomo pred namestitvijo
    ...
    <p>
      ...
      pošiljamo osnovno prilagojena sporočila, za katere ocenimo, da bi vas
    ...
    <p>
      Ko na naše kontaktne podatke (naslov, elektronski naslov, telefonska
      številka), objavljene na naših spletnih straneh, pošljete povpraševanje po
      določeni storitvi, vaše osebne podatke obdelujemo izključno za namene
      ...
      bili lahko zanimivi na podlagi vaših preteklih interakcij z nami. Pri tem
    ...
    <p>
      ...
      strani. Piškotki vsebujejo različne informacije, ki jih spletna stran
      prebere, ko jo ponovno obiščete. Uporablja jih večina sodobnih spletnih
      strani. Sami po sebi piškotki niso škodljivi, ne vsebujejo virusov ali
      kakšne drugačne zlonamerne kode. Uporabljajo se za različne namene, za
      seje (npr. prijavljanje v uporabniški račun), za košarice v spletnih
      trgovinah, za prikaz različnih naprednih vsebin na spletni strani(npr.
      zemljevidi, video), za vodenje statistike obiska strani, za podporo
    ...
    <p>
      Začasni ali sejni piškotki (session cookies) »živijo« od trenutka, ko
      uporabnik odpre brskalnik, pa do trenutka, ko sejo konča in zapre
      brskalnik. Spletna mesta jih uporabljajo za shranjevanje začasnih
    ...
    <h3>KATERE PODATKE ZBIRAMO Z UPORABO PIŠKOTKOV?</h3>
    <p>
      Z uporabo piškotkov zbiramo naslednje podatke obiskovalcev naših spletnih
      strani:
    </p>
    <ul>
      <li>informacije o napravi (vrsta, znamka in tip),</li>
      <li>informacije o operacijskem sistemu (vrsta in verzija),</li>
      <li>informacije o spletnem brskalniku (vrsta in verzija),</li>
      <li>informacije o nastavitvah zaslona (npr. resolucija),</li>
      <li>informacije o straneh, ki so bile prikazane.</li>
    </ul>
    <p>
    ...
    <ul>
      <li>IP naslov,</li>
      <li>podatke o lokaciji oziroma vstopni točki dostopa do interneta,</li>
      <li>podatke o elektronskem naslovu in geslu,</li>
      <li>vnose v spletne obrazce,</li>
      <li>vnose v nakupovalno košarico.</li>
    </ul>
    <p>
      Te podatke potrebujemo zaradi potrebe avtentikacije uporabnikov naše
      spletne trgovine, in sicer da se lahko prepričamo, da je prijavo izvedel
      registriran oziroma prijavljen uporabnik. Nadalje te podatke potrebujemo
      za to, da si spletno mesto zapolni uporabnikov vnos v spletne obrazce in
      nakupovalno košarico. Prav tako pa te podatke uporabljamo za vodenje
      statistike in za izvajanje marketinških aktivnosti.
    </p>
    <h3>VRSTE PIŠKOTKOV, KI JIH UPORABLJAMO NA WWW.SVETINA-RANCH.SI</h3>
    <h4>LASTNI IN NUJNO POTREBNI PIŠKOTKI:</h4>
    <p>
      ...
      spletni strani. Tudi ti piškotki so nujno potrebni.
    </p>
    <table>
      <thead>
        <th>Ime piškotka</th>
      ...
      <tbody>
        <tr>
          <td>mp_ga</td>
          <td>sistemski piškotek</td>
          <td>Trajanje: do 10 let</td>
        </tr>
        <tr>
          <td>teak-cart</td>
          <td>sistemski piškotek</td>
          <td>Trajanje: do 1 mesec</td>
        </tr>
        <tr>
          <td>mp_acookie</td>
          <td>sistemski piškotek</td>
        ...
        <tr>
          <td>popover-dan</td>
          <td>sistemski piškotek</td>
          <td>Trajanje: do 1 dan</td>
        </tr>
        <tr>
          <td>mp_currentlang</td>
          <td>sistemski piškotek</td>
          <td>Trajanje: do 1 mesec</td>
        </tr>
        <tr>
          <td>5a3deac1009db2c066ac1acaf08b8941</td>
          <td>sistemski piškotek</td>
          <td>Na sejo</td>
        </tr>
      </tbody>
    ...
    <h4>
      DRUGI PIŠKOTKI KOT SO PIŠKOTKI DRUŽABNIH OMEREŽIJ, PIŠKOTKI ZA ANALITIKO
      TER PIŠKOTKI ZA OGLAŠEVALSKE AKTIVNOSTI:
    </h4>
    <p>
      Druge piškotke uporabljamo za to, da nam pomagajo pri optimizaciji naše
      spletne strani in izboljšavah njene funkcionalnosti. Te piškotke
      uporabljamo le, če ste z njihovo namestitvijo soglašali.
    </p>
    <h4>GOOGLE ANALYTICS PIŠKOTKI:</h4>
    <p>
      ...
      v Združenih državah. Preden vaš naslov IP pošljemo podjetju Google, ga
      anonimiziramo. Podjetje Google v skladu s potrdilom o zasebnostnem ščitu
      izjavlja, da spoštuje okvir zasebnostnega ščita, sklenjen med EU in ZDA. V
    ...
    <p>
      Sejne in trajne piškotke Google uporablja za mnoge funkcionalnosti, kamor
      štejemo shranjevanje priljubljenih uporabniških nastavitev, prikazovanje
      Google zemljevidov in njihovih funkcionalnosti, prikazovanje oglasov po
      meri uporabnikom, uskladitev prikazov oglasov na različnih napravah in
      njihove meritve, itd.
    </p>
    <table class="table">
      <thead>
      ...
      <tbody>
        <tr>
          <td>1P_JAR</td>
          <td>Google piškotek</td>
          <td>Trajanje: do 1 mesec</td>
        </tr>
        <tr>
          <td>AID</td>
          <td>Google piškotek</td>
          <td>Trajanje: do 2 leti</td>
        </tr>
        <tr>
          <td>APISID</td>
          <td>Google piškotek</td>
    ...
    <h4>FACEBOOK PIŠKOTKI:</h4>
    <p>
      Sejni in trajni piškotki Facebook spletne strani omogočajo prijazno
      izkušnjo skupne rabe, kajti omogočajo preprosto interakcijo preko
      družabnih omrežij in beležijo metrike kot so število delitev, všečkov,
      komentarjev in ustvarjanje oglasov po meri uporabnikov.
    </p>
    <table class="table">
      <thead>
        <th>Ime piškotka</th>
      ...
      <tbody>
        <tr>
          <td>FR</td>
          <td>Facebook piškotek</td>
          <td>Trajanje: do 6 mesecev</td>
        </tr>
      </tbody>
    </table>
    <h4>
      NENUJNE PIŠKOTKE LAHKO ENOSTAVNO ODSTRANITE, ČE SLEDITE NAVODILOM NA
      SPODNJIH POVEZAVAH:
    </h4>
    <p>
      ...
      <a
        target="_blank"
        href="https://support.google.com/chrome/answer/95647?hl=sl"
        >Preberi NAVODILA >></a
      >
    </p>
    <p>
      Brskalnik MOZILLA FIREFOX:
      <a
        target="_blank"
        href="https://support.mozilla.org/sl/kb/izbrisite-piskotke-podatke-strani?redirectlocale=sl&redirectslug=izbrisite-piskotke"
        >Preberi NAVODILA >></a
      >
    </p>
    <p>
      ...
      <a
        target="_blank"
        href="https://support.microsoft.com/sl-si/help/17442/windows-internet-explorer-delete-manage-cookies"
        >Preberi NAVODILA >></a
      >
    </p>
    <p>
